"""Tool integration suite — registers `_in_memory.py` under a unique alias
(mirror of unit's, because integration has its own copy of the file)."""
...
_ALIAS = "_tool_integration_in_memory"
